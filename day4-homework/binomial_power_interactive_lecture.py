...
fig, ax = plt.subplots()
ax=sns.heatmap(power_mat, vmin=0, vmax=1, cmap="Spectral",
                xticklabels=tosses, yticklabels=probs)
ax.set_xlabel("number of tosses")
ax.set_ylabel("probability of successes")
ax.set_title("the power of the probability of successes over trials")
fig.savefig("power_mat.png")